        ...
        <div class="w-full max-w-md space-y-8">
            ...
            <form id="login-form" class="space-y-6 bg-content-bg shadow-lg rounded-xl p-6 border border-custom-border">
                <div>
                    ...
                    <input placeholder="نام کاربری" dir="ltr" id="username" name="username" type="text" required class="mt-1 block w-full rounded-md border-2 border-custom-border bg-white p-2 text-black shadow-sm focus:border-2 outline-none focus:border-green-600"/>
                </div>
                
                <div class="relative">
                    <label for="password" dir="ltr" class="block text-sm font-medium text-custom-text">رمز عبور</label>
                    <input placeholder="رمز عبور" dir="ltr" id="password" name="password" type="password" required class="mt-1 block w-full rounded-md border-2  border-custom-border text-black bg-white p-2 pr-10 shadow-sm focus:border-2 outline-none focus:border-green-600" />
