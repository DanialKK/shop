        ...
        <div class="w-full max-w-md space-y-8">
            ...
            <form id="register-form" class="space-y-6 bg-content-bg shadow-lg rounded-xl p-6 border border-custom-border">
                <div>
                    ...
                    <input placeholder="نام کاربری" dir="ltr" id="new-username" name="username" type="text" required class="mt-1 block w-full rounded-md border-custom-border bg-white border border-b-gray-400 p-2 text-black shadow-sm focus:border-primary focus:ring-primary"/>
                </div>
                
                <div>
                    <label for="new-email" dir="ltr" class="block text-sm font-medium text-custom-text">ایمیل</label>
                    <input placeholder="ایمیل" dir="ltr" id="new-email" name="email" type="email" required class="mt-1 block w-full rounded-md border-custom-border bg-white border border-b-gray-400 p-2 text-black shadow-sm focus:border-primary focus:ring-primary"/>
                </div>

                <div class="relative">
                    <label for="new-password" dir="ltr" class="block text-sm font-medium text-custom-text">رمز عبور</label>
                    <input placeholder="رمز عبور" dir="ltr" id="new-password" name="password" type="password" required class="mt-1 block w-full rounded-md border-custom-border text-black bg-white border border-b-gray-400 p-2 pr-10 shadow-sm focus:border-primary focus:ring-primary" />
                ...
                <div class="relative">
                    ...
                    <input placeholder="تکرار رمز عبور" dir="ltr" id="confirm-password" name="confirmPassword" type="password" required class="mt-1 block w-full rounded-md border-custom-border text-black bg-white border border-b-gray-400 p-2 pr-10 shadow-sm focus:border-primary focus:ring-primary" />
